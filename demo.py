...
def main(yolo):
    ...
    # deep_sort
    model_filename = 'model_data/models/mars-small128.pb' #Pre-trained Model is kept in this
    encoder = gdet.create_box_encoder(model_filename, batch_size=1)  #For feature extraction
    ...
    for frame in all_frames:
        ...
        boxs = yolo.detect_image(image)  # n * [topleft_x, topleft_y, w, h] returns list of bounding boxes
        features = encoder(frame, boxs)  # n(persons detected) * 128
            ...
            if len(exist_ids) == 0:
                ...
                for nid in new_ids:
                    ...
                    if dis[0][1] < th:
                        ...
                        final_fuse_id[nid] = [nid]
    print('Final ids and sub-ids:', final_fuse_id)
    ...
    print('\nWriting : {} seconds'.format(int(time.time() - t2)))
